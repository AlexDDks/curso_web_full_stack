...
router.get('/registro', mainControllers.registro) //En el playground, ellos usan este sistema de ruteo, todo a un mismo controlador

module.exports = router //Se exporta la variable router
