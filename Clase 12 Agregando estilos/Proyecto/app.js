...
//Se setea la ruta a la carpeta public. 
...
})//Generamos ruta, cuando entremos a la ruta local 3000, respondemos con una solicitud. El resolve del módulo path permite enviar cualquier archivo html al navegador

app.get('/2', (req, res) => {
    res.sendFile(path.resolve(__dirname, './views/home2.html'))//ponemos la ruta absoluta del archivo html usando dirname (no se aceptan rutas relativas)
